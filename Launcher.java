...
//        updateGlobalIcons();
        ...
        findViewById(R.id.iv_yibiao).setOnTouchListener(this);
        findViewById(R.id.iv_air).setOnTouchListener(this);
        findViewById(R.id.iv_radio).setOnTouchListener(this);
        findViewById(R.id.iv_usb).setOnTouchListener(this);
        findViewById(R.id.iv_daoche).setOnTouchListener(this);
    }
...
//        mHotseat = (Hotseat) findViewById(R.id.hotseat);
        ...
        mWorkspace.setPageSwitchListener(new PageSwitchListener() {
			...
			public void onPageSwitch(View newPage, int newPageIndex) {
				...
				case 0:
					initLevel();
					findViewById(R.id.iv_yibiao).getBackground().setLevel(1);
					break;
				case 1:
					initLevel();
					findViewById(R.id.iv_air).getBackground().setLevel(1);
					break;
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (Intent.ACTION_MAIN.equals(intent.getAction())) {
            ...
            final boolean apps = intent.getBooleanExtra("apps", false);
...
//        }
    ...
    private void setViewLevel(View v){
    	initLevel();
		...
		case R.id.iv_air:
			...
			break;
		case R.id.iv_radio:
			findViewById(R.id.iv_radio).getBackground().setLevel(1);
			Intent it = new Intent();
    		it.setClassName("com.tw.radio", "com.tw.radio.RadioActivity");
    		startActivity(it);
			break;
		case R.id.iv_usb:
			findViewById(R.id.iv_usb).getBackground().setLevel(1);
			Intent it2 = new Intent();
			it2.setClassName("com.tw.music", "com.tw.music.MusicActivity");
    		startActivity(it2);
			break;
		case R.id.iv_daoche:
			findViewById(R.id.iv_daoche).getBackground().setLevel(1);
			showAllApps(true);
			break;
		}
    }
    ...
    private void initLevel(){
        findViewById(R.id.iv_yibiao).getBackground().setLevel(0);
        findViewById(R.id.iv_air).getBackground().setLevel(0);
        findViewById(R.id.iv_radio).getBackground().setLevel(0);
        findViewById(R.id.iv_usb).getBackground().setLevel(0);
        findViewById(R.id.iv_daoche).getBackground().setLevel(0);
    }
    
    private void setIndexIndicator(int currentScreen) {
